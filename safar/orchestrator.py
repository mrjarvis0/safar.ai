...
def _observe(state: TripState) -> None:
    ...
    try:
        ...
        all_agents = ("flight", "hotel", "activity", "intercity", "discovery",
                      "risk", "support", "enroute", "seasonality",
                      "connection_risk", "fare_rules", "route_optimizer",
                      "document", "connectivity", "sustainability", "emergency",
                      "profile")
